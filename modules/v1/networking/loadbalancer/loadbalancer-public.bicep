// Bicep module to deploy a standard public load balancer
...
@description('Tier of Load Balancer')
@allowed([
  'Global'
  'Regional'
])
...
@description('Name of the Public IP the load balancer will use')
    ...
    frontendIPConfigurations: [
      {
        ...
        properties: {
          publicIPAddress: {
            id: resourceId('Microsoft.Network/publicIPAddresses', lbPublicIpName)
          }
        }
      }
    ]
