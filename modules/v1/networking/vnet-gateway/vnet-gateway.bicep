...
resource publicIP02 'Microsoft.Network/publicIPAddresses@2020-06-01' = if(gatewayType == 'Vpn') {
...
resource publicIP03 'Microsoft.Network/publicIPAddresses@2020-06-01' = if(gatewayType == 'Vpn') {
...
resource virtualNetworkGateway 'Microsoft.Network/virtualNetworkGateways@2020-11-01' = {
  ...
  tags: !empty(tags) ? tags : null
  properties: {
    activeActive: gatewayType == 'ExpressRoute' ? false : true
    // Assign 1 IP config if Expressroute gateway, 3 IP configs if VPN gateway
    ipConfigurations: gatewayType == 'ExpressRoute' ? [
      {
        name: 'default'
        properties: {
    ...
    vpnType: gatewayType == 'ExpressRoute' ? null : 'RouteBased'
    vpnClientConfiguration: gatewayType == 'ExpressRoute' ? null : {
