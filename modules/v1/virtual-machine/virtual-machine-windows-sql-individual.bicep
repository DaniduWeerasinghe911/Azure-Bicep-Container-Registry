...
param operatingSystem string = 'enterprise'
...
param autoBackupSystemDbs bool = false
...
resource sql_vm 'Microsoft.SqlVirtualMachine/sqlVirtualMachines@2021-11-01-preview' = {
  name: virtualMachineNameSuffix
  location: location
  properties: {
...
/* Resource Lock
resource deleteLock 'Microsoft.Authorization/locks@2016-09-01' = {
